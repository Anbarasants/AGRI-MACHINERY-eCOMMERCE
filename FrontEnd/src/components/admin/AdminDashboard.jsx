...
const AdminDashboard = () => {
  ...
  const recentOrders = [
    { id: 1, customer: "John Doe", product: "Tractor", amount: 450000, status: "Pending" },
    { id: 2, customer: "Jane Smith", product: "Sprayer", amount: 15000, status: "Delivered" },
    { id: 3, customer: "Mike Johnson", product: "Harvester", amount: 850000, status: "Processing" }
  ];
      ...
      <div className="bg-white p-4 rounded-lg shadow-md">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="flex gap-2">
            <select className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500">
            ...
            <tr>
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <div className="text-sm font-medium text-gray-900">Tractor Model X1</div>
                    <div className="text-sm text-gray-500">John Deere</div>
                  </div>
                </div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Tractors</td>
        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            <tr>
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">9876543210</td>
          ...
          <div>
            ...
            <div className="mt-4 space-y-4">
              <div>
                ...
                <input type="text" className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2" defaultValue="Arul Jayam Agri Machinery" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700">Contact Email</label>
                <input type="email" className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2" defaultValue="contact@aruljayam.com" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700">Phone Number</label>
                <input type="tel" className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2" defaultValue="+91 9876543210" />
              </div>
            </div>
          </div>
